...
public class respawn_witch_script : MonoBehaviour
{
  ...
  Instantiate(animals[UnityEngine.Random.Range(0, animals.Length )],new Vector3(Random.Range(-60f,45f), 1.5f,Random.Range(20f,100f)), Quaternion.identity);
  Instantiate(animals[UnityEngine.Random.Range(0, animals.Length )],new Vector3(Random.Range(-60f,45f), 1.5f,Random.Range(20f,100f)), Quaternion.identity);
  Instantiate(animals[UnityEngine.Random.Range(0, animals.Length )],new Vector3(Random.Range(-60f,45f), 1.5f,Random.Range(20f,100f)), Quaternion.identity);
      Invoke("selfdestroy", 1.4f);
    }
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        // if ( bwall != null)
        // {
        //     transform.position = new Vector3(Random.Range(-99,90),2f, 30);
